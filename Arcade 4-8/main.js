...
then loop thorugh the indiviual arrays in the main array
if the value of the array is zero then make all the values in that column of values zero
then loop through the arrays and array in arrays
add the numbers to the placeholder
return the toal
*/
